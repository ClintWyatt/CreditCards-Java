...
/**
 * The JCB class determines whether if the string argument from the CreditCardDemo
 ...
 * @version 0.3.2
 */
public class JCB extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String jcbStart = "31";
    private String jcbStart1 = "33";
    private String cardStart = "JCB";
    private String creditCardNumber;

    /**
     * The JCB constructor accepts a string from CreditCardDemo, which
     ...
     * visa numbers. If the creditcard does start with the starting JCB numbers, then 
     * "JCB" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the JCB starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(jcbStart1))
           creditCardNumber =  "JCB "  + creditCardNumber;
        
        else if(creditCardNumber.startsWith(jcbStart))
           creditCardNumber =  "JCB "  + creditCardNumber;
