...
/**
 * The Maestro class determines whether if the string argument from the CreditCardDemo
 * (Which is a string of a credit card number from the file "CreditCardNumbers.txt")
 * is a Maestro creditcard..
 ...
 * @version 0.1.2
 */
public class Maestro extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String maestroStart = "58";
    private String cardStart = "Maestro";
    private String creditCardNumber;

    /**
     * The Maestro constructor accepts a string from CreditCardDemo, which
     ...
     * maestro numbers. If the creditcard does start with the starting meastro numbers, then 
     * "maestro" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the maestro starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(maestroStart))
           creditCardNumber =  "Maestro "  + creditCardNumber;
