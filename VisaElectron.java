...
/**
 * The VisaElectron class determines whether if the string argument from the CreditCardDemo
 * (Which is a string of a credit card number from the file "CreditCardNumbers.txt")
 * is a VisaElectron creditcard.
 ...
 * @version 1.0.2
 */
public class VisaElectron extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String electronStart = "48";
    private String electronStart1 = "49";
    private String cardStart = "VisaElectron";
    private String creditCardNumber;

    /**
     * The VisaElectron constructor accepts a string from CreditCardDemo, which
     * is the creditcard number from CredCardNumbers.txt
     * @param String str
     * @returns none
     * @throws none implemented
     */
    public VisaElectron(String str)
    {
     ...
     * visaElectron numbers. If the creditcard does start with the starting VisaElectron numbers, then 
     * "VisaElectron" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the VisaElectron starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(electronStart1))
           creditCardNumber =  "VisaElectron "  + creditCardNumber;
        
        else if(creditCardNumber.startsWith(electronStart))
           creditCardNumber =  "VisaElectron "  + creditCardNumber;
