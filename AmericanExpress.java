...
/**
 * The AmericanExpress class determines whether if the string argument from the CreditCardDemo
 * (Which is a string of a credit card number from the file "CreditCardNumbers.txt")
 * is a AmericanExpress creditcard.
 ...
 * @version 0.1.2
 */
public class AmericanExpress extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String expressStart = "37";
    private String expressStart1 = "34";
    private String creditCardNumber;

    /**
     * The AmericanExpress constructor accepts a string from CreditCardDemo, which
     * is the creditcard number from CredCardNumbers.txt
     * @param String str
     * @returns none
     * @throws none implemented
     */
    public AmericanExpress(String str)
    {
     ...
     * AmericanExpress numbers. If the creditcard does start with the starting AmericanExpress numbers, then 
     * "AmericanExpress" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the AmericanExpress starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(expressStart))
           creditCardNumber =  "AMEX "  + creditCardNumber;
        
        else if(creditCardNumber.startsWith(expressStart1))
           creditCardNumber =  "AMEX "  + creditCardNumber;
    ...
    public String firstLetters(){
        String start = "AMEX";
        String start1 = new String(start);
        return start1;
    }
}