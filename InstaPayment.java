...
/**
 * The InstaPayment class determines whether if the string argument from the CreditCardDemo
 * (Which is a string of a credit card number from the file "CreditCardNumbers.txt")
 * is a InstaPayment creditcard.
 ...
 * @version 0.2.2
 */
public class InstaPayment extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String instStart = "63";
    private String cardStart = "InstaPayment ";
    private String creditCardNumber;

    /**
     * The InstaPayment constructor accepts a string from CreditCardDemo, which
     * is the creditcard number from CredCardNumbers.txt
     * @param String str
     * @returns none
     * @throws none implemented
     */
    public InstaPayment(String str)
    {
     ...
     * InstaPayment numbers. If the creditcard does start with the starting InstaPayment numbers, then 
     * "InstaPayment" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the InstaPayment starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(instStart))
