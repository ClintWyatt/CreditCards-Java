 ...
 * @version 0.2.2
 */
public class Laser extends ValidateCreditCard
{
    // instance variables - replace the example below with your own
    private String laserStart = "67";
    private String cardStart = "Laser";
    private String creditCardNumber;

    /**
     * The Laser constructor accepts a string from CreditCardDemo, which
     * is the creditcard number from CredCardNumbers.txt
     * @param String str
     * @returns none
     * @throws none implemented
     */
    public Laser(String str)
    {
     ...
     * Laser numbers. If the creditcard does start with the starting Laser numbers, then 
     * "Laser" is added the the beginning of the credidcard number. If the creditcard 
     * number does not start with any of the Laser starting numbers, then the creditcard is
    ...
    public void validate(){
        ...
        if(creditCardNumber.startsWith(laserStart))
           creditCardNumber =  "Laser "  + creditCardNumber;
